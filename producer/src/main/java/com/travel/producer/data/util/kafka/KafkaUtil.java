package com.travel.producer.data.util.kafka;


import com.travel.producer.data.util.zookeeper.ZKClientUtil;
...
//     */
    ...
    public static KafkaProducer<String, String> createProducer(String path) throws IOException {
        ...
        props.setProperty("group.id","ods");
    ...
    public static void main(String[] args){
        ...
        String zkServers = "192.168.193.111:2181,192.168.193.112:2181,192.168.193.113:2181/kafka";
